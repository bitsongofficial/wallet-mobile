						...
						<>
							<View>
								...
								<Subtitle style={styles.subtitle}>
									This is the only way you will be able to {"\n"}recover your account. Please store
									it {"\n"}somewhere safe!
								</Subtitle>
							</View>
							{controller.steps.active === 0 ? (
								...
								<ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollviewContent}>
									...
									{controller.steps.active === 3 && <SetPin pin={controller.confirm} />}
								</ScrollView>
							)}
							...
							<Footer
								onPressBack={goBack}
								onPressNext={
									controller.steps.active === 3 && controller.isCanNext ? saveWallet : goNext
								}
