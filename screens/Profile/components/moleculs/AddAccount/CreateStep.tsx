...
export default observer(({ isHidden, onPressToggle, phrase }: CreateStepProps) => {
		...
		<>
			...
			<View style={{ alignItems: "center" }}>
				{isHidden ? (
					...
					>
						<GradientText style={[styles.text, theme.text.primary]}>Hide</GradientText>
					</Button>
				)}
			</View>
			<BottomSheetScrollView style={{ flexGrow: 1 }} contentContainerStyle={{ paddingBottom: 116 }}>
				<PhraseView style={styles.phrase} hidden={isHidden} value={phrase.words} />
